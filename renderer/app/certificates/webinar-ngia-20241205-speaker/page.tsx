	...
	return (
		<A4Wrapper backgroundImageSrc={BackgroundImage}>
			<div className={styles.background}>
				...
				<p className={styles.text}>foi palestrante no Webinar Dismenorreia e Endometriose na Adolescência, organizado pelo Núcleo de Ginecologia da Infância e Adolescência da SPG, no dia 5 de Dezembro de 2024.</p>
