	...
	return (
		<A4Wrapper backgroundImageSrc={BackgroundImage}>
			<div className={styles.background}>
				...
				<p className={styles.text}>participou no Webinar Infeções Sexualmente Transmissíveis na Adolescência, organizado pelo Núcleo de Ginecologia da Infância e Adolescência da SPG, no dia 21 de Maio de 2025.</p>
